...
export class InitialSchema1781678170061 implements MigrationInterface {
    name = 'InitialSchema1781678170061'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "tx_status" ("id" SERIAL NOT NULL, "eventRef" character varying(200), "tenantId" character varying(64), "transactionReference" character varying(256), "eventType" text, "transactionType" text, "status" text, "stage" text, "payload" jsonb NOT NULL, "receivedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_894e1b0e08a8ef28c456755d849" PRIMARY KEY ("id"))`);
