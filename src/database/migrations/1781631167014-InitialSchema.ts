...
export class InitialSchema1781631167014 implements MigrationInterface {
    name = 'InitialSchema1781631167014'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "kv_store" ("key" character varying(256) NOT NULL, "value" text NOT NULL, "expiresAt" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_a9c11644aa565bf7675e6bd23ef" PRIMARY KEY ("key"))`);
        await queryRunner.query(`CREATE INDEX "IDX_71bfaef45238ce1a199f4366e2" ON "kv_store" ("expiresAt") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_71bfaef45238ce1a199f4366e2"`);
